...
On the local Python 3.11 environment:

- `python -m pytest -q`: **19 passed**, covering multi-step boundary overlap, future-data invariance, delayed labels, missing targets, training-only preprocessing, temporal scorer evaluation, scorer independence from test ratings, duplicate handling, stable identifiers, and end-to-end artifact generation.
